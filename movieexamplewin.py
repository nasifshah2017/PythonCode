...
playMovie(makeRectMovie("w:\\cs128\\lectures\\examples\\testmovie"))
...
#playMovie(tickertape("w:\\cs128\\lectures\\examples\\testmovie", "Hello, I learn this in CS128!!"))
...
#playMovie(moveHead("w:\\cs128\\lectures\\examples\\testmovie"))
...
playMovie(slowsunset("w:\\cs128\\lectures\\examples\\testmovie"))
...
#playMovie(moveHead2("w:\\cs128\\lectures\\examples\\testmovie"))
...
#playMovie(slowfadeout("w:\\cs128\\lectures\\examples\\testmovie"))

import os
def ligtenFish(directory):
  framenum = 0
...
#playMovie(ligtenFish("w:\\cs128\\lectures\\examples\\testmovie"))
